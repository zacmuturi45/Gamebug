    ...
    return (
        <div className='follower-maindiv'>
            <div className="follower-div">
                <SearchBar search={"followers"} />
                <div className='follower-div-div'>
                    {
                        gameUserData.map((data, index) => {
                            return <FollowData image={data.image} name={data.name} edits={data.edits} followerCount={data.followerCount} index={index} follow={"Unfollow"} />
                        })
                    }
                </div>
            </div>
